...
export class OrConfRealmCard extends LitElement {
    ...
    protected _getColors() {
        const colors: { [name: string]: string } = {
            ...
            "--or-app-color7": unsafeCSS(DefaultColor7).toString(),
                ...
                <div slot="content" class="panel-content">
                    ...
                    <div class="color-group">
                        ...
                        <div>
                            ...
                            <or-mwc-input class="color-item" .type="${InputType.COLOUR}" value="${colors["--or-app-color7"]}"
                                          .label="${i18next.t("configuration.--or-app-color7")}"
                                          @or-mwc-input-changed="${(e: OrInputChangedEvent) => app._setColor("--or-app-color7", e.detail.value)}"></or-mwc-input>
